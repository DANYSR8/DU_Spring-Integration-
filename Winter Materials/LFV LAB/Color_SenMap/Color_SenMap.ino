...
void loop() 
{
  ...
  RredCol = map(RredFreq, 48, 195, 255, 0);
  ...
  RgreenCol = map(RgreenFreq, 61, 313, 255, 0);
  ...
  RblueCol = map(RblueFreq, 52, 332 , 255, 0);
  ...
  // Remaping the value of the RED (R) frequency from 0 to 255
  LredCol = map(LredFreq, 45, 222, 255, 0);
  // Printing the RED (R) value
  Serial.print(" LR = ");
  ...
  // Remaping the value of the GREEN (G) frequency from 0 to 255
  LgreenCol = map(LgreenFreq, 55, 332, 255, 0);
  // Printing the GREEN (G) value  
  Serial.print(" LG = ");
  ...
  // Remaping the value of the BLUE (B) frequency from 0 to 255
  LblueCol = map(LblueFreq, 52, 332, 255, 0);
  // Printing the BLUE (B) value 
  Serial.print(" LB = ");
